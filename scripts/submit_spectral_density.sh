...
#!/bin/bash
#SBATCH --job-name=spectral-density
...
SCRIPT_FILE="${SUBMIT_DIR}/scripts/compute_spectral_density_with_injections.py"
...
echo "Task ${TASK_ID}: offset=${OFFSET} batch=${BATCH_SIZE} workers=${NWORKERS} chunksize=${CHUNKSIZE} output=${OUTPUT_FILE}"
