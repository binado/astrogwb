...
- **`amplitude_toy_model.py`** — smoke-test sibling of `mcmc.py`: same pipeline scaffolding, but the cosmology/population callback is replaced by a trivial single-parameter amplitude model, to sanity-check that NUTS recovers a known injection
