...
from astrogwb.runtime import colab_tpu_available, configure_runtime
...
def test_colab_tpu_available_from_device(
    ...
    monkeypatch.setattr(
        "astrogwb.runtime.os.path.exists", lambda path: path == "/dev/accel0"
    )
...
def test_colab_tpu_available_from_legacy_environment(
    ...
    monkeypatch.setattr("astrogwb.runtime.os.path.exists", lambda path: False)
