...
\begin{equation}
	\langle I(f, \theta) \rangle_\iota = \frac{1}{\mathcal{N}} \int_0^\pi d\iota p(\iota) \left[|\tilde{h}_{+}(f, \theta)|^2 + |\tilde{h}_{\times}(f, \theta)|^2\right],
	\label{eq:inclination-averaged-waveform}
\end{equation}

where the normalization factor $\mathcal{N}$ is given by

\begin{equation}
	\mathcal{N} = \int_0^\pi d\iota p(\iota).
	\label{eq:inclination-averaged-waveform-normalization}
\end{equation}
...
the sky, in which case $\mathcal{N} = 2$. Thus,
Eq.~\eqref{eq:inclination-averaged-waveform} becomes:

\begin{align}
	\nonumber
	\langle I(f, \theta) \rangle_\iota & = \frac{1}{2} |A(f, \theta)|^2 \int d\cos\iota \left[ \left(\frac{1 + \cos^2\iota}{2}\right)^2 + \cos^2\iota \right] \\
	\nonumber
	                                   & = \frac{4}{5} |A(f, \theta)|^2                                                                                       \\
