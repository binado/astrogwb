...
- **`paper/importance_weights_grid.py`** — evaluate mean importance weights on prior-support grids for the hard-coded $H_0$–$\Omega_m$ and $\Xi_0$–$n$ combinations, and plot heatmaps with the paper style
