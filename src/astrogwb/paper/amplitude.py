"""JAX-touching glue between :class:`~astrogwb.paper.config.mcmc.RunConfig`
...
:data:`~astrogwb.paper.config.mcmc.PriorDistribution`).
"""
...
def build_amplitude_marginalization(config: RunConfig) -> AmplitudeMarginalization:
    ...
    :class:`~astrogwb.paper.config.mcmc.AnalysisConfig`.
    """
