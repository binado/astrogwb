...
*means* is "the arguments that rebuild a :class:`Population`".
:meth:`to_attrs` and :meth:`from_attrs` trade plain dictionaries, so this
module never imports h5py and the population layer stays free of a
...
from astrogwb.populations.registry import Population, build_population
