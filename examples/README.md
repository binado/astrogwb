...
Nothing here imports `astrogwb.paper` or assumes a repository checkout, so each
...
makes the weights informative. See the paper application in the source
repository.
...
the paper application, and it is how every production analysis is set up.
